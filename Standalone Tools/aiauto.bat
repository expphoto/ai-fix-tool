...
# ...rest of script...
'@ | Out-File -FilePath C:\Windows\Temp\ai-auto.ps1 -Encoding UTF8

powershell -NoProfile -ExecutionPolicy Bypass -File C:\Windows\Temp\ai-auto.ps1 -Goal "Investigate slowness" -AllowMaintenance
